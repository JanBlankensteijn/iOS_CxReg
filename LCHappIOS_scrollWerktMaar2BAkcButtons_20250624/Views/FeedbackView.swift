...
enum UXScherm: String, CaseIterable, Identifiable {
    ...
    case codelijst = "Codelijst"
    var id: String { self.rawValue }
}

enum InhoudActie: String, CaseIterable, Identifiable {
    case voegToe = "Voeg complic/loc/code toe"
    case verwijder = "Inactiveer complic/loc/code"
...
struct FeedbackView: View {
    ...
    @State private var geselecteerdeUXScherm: UXScherm = .complicaties
    @State private var geselecteerdeInhoudActie: InhoudActie
    @State private var feedback: String = ""
    @State private var verzonden = false

    init(categorie: String = "UX", actie: String = "Complicaties", voorafIngevuld: String? = nil, herkomst: String? = nil) {
