                ...
                Group {
                    ...
                    HStack(alignment: .top, spacing: 12) {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            Text("Zoekfunctie:")
                                .font(.body)
                                .bold()
                            Text("Type termen in het zoekveld om compLOCaties en codes te filteren (per karakter wordt het filter bijgewerkt).  Meerdere zoektermen (gescheiden door spaties) kunnen worden gecombineerd (EN-filter). Indien een term uit drie hoofdletters bestaat wordt in de code (GRP.SRT.SPC.LOC)gezocht.")
                                .font(.subheadline)
                        }
                    }
                    ...
                    HStack(alignment: .top, spacing: 12) {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            ...
                            Text("In 1e instantie worden in de complicatie~locatie-lijst alleen actieve compLOCaties getoond. Als de slider (boven het zoekvak) uitgezet wordt, toont het filter ook inactieve compLOCaties (rood en doorgestreept).")
                                .font(.subheadline)
                        }
                    }
